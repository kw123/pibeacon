...
class DFRobot_DF2301Q_I2C(DFRobot_DF2301Q):
	...
	def set_wake_time(self, wake_time):
		'''!
			...
			@param wakeTime - Wake-up duration(0-255) secs
		'''
...
def readParams():
	...
	global startTime, lastMeasurement, sendToIndigoSecs, oldi2cOrUart
	try:
		...
		for devId in sensors[sensor]:
			...
			if upd: U.logger.log(30,"setting mode:{} volume:{}, mute:{}, setWakeTime:{}".format(i2cOrUart, sensors[sensor][devId].get("volume"), sensors[sensor][devId].get("mute"), sensors[sensor][devId].get("setWakeTime")) )
...
def execSensorLoop():
	...
	global oldi2cOrUart, sensorsOld
