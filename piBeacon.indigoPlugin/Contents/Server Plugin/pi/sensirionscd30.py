...
def getValues(devId):
	...
	try:
		...
		try:
			data = {"temp":	round(temp,1), "CO2": int(CO2), "hum": int(hum+0.5), "deviceVersion":deviceVersion[devId], "autoCalibration": autoCalibration[devId], "sensorTemperatureOffset": sensorTemperatureOffset[devId],"sensorCo2Target":sensorCo2Target[devId], "altitudeCompensation":altitudeCompensation[devId]} 
